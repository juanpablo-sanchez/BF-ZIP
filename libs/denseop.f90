...
interface tracemat
  module procedure trace_mat4, trace_mat8
end interface 
...
function trace_mat4(x) result(tr)
real(r4) :: x(:,:)
real(r4) :: tr
integer::i,m,n,ord
m=size(x,1)
...
do i=1,ord
   tr = tr + x(i,i)
enddo
end function trace_mat4

function trace_mat8(x) result(tr)
real(r8) :: x(:,:)
real(r8) :: tr
integer::i,m,n,ord
m=size(x,1)
...
!       f) if optional showeig is present print eigenvalues
!
